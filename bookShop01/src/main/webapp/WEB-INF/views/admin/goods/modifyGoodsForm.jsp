        ...
        <DIV class="tab_container">
            <DIV class="tab_content" id="tab1">
                <table>
                    ...
                    <tr>
                        <td>상품판매가격</td>
                        <td><input name="goods_sales_price" type="text" size="40" value="${goods.goods_sales_price }"/>
                        </td>
                        <td>
                            <input type="button" value="수정반영"
                    ...
                    <tr>
                        <td>상품 총 페이지수</td>
                        <td><input name="goods_total_page" type="text" size="40" value="${goods.goods_total_page }"/>
                        </td>
                        <td>
                            <input type="button" value="수정반영"
